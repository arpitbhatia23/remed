...
const Navbar = () => {
  ...
  return (
    <header className=''>
      <nav className='flex items-center justify-between py-6 px-8 font-frenchCanon'>
        <div className='flex'>
          <Logo />
        </div>
        ...
        {/* Mobile Menu */}
        <ul className={`fixed top-0 right-0 w-2/4 h-full bg-[#0b090aab] flex flex-col items-center justify-start py-4 space-y-6 text-2xl text-white transition-transform transform ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'} sm:hidden z-40`}>
        <button
